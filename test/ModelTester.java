...
public class ModelTester
{
   public static void main(String[] args)
   {
       ...
       */
      Device device2 = new Device("second device id", 
                                  new DeviceType("second device type"), 
                                  "second device agent",
                                  "second device location");
       ...
       */
      SensorReading reading2 = new SensorReading("device id 2",
            "sensor type 2", "666", "8888888");
